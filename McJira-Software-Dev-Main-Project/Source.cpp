...
int main() {
    ...
    while (playGame)
    {
        ...
        cout << "Remaining Enemies: " << Enemy::getRemainingEnemies() + 20;
        ...
        while (true) {
            ...
            if (Enemy::getRemainingEnemies() + 20 <= 0)
            {
                cout << "Congatulations!!! \n You have defeated all the enemies and won the game!!!\n If you would like to play again type YES, if you'd like to quit type NO: \n";  
            }
